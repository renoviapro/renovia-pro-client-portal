  ...
  return (
    <div>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link to="/tickets/new" className="block rounded-xl border border-white/20 bg-white/5 p-6 no-underline hover:border-[#febd17]/50">
        ...
        <a href="https://depannage.renoviapro.fr" target="_blank" rel="noopener noreferrer" className="block rounded-xl border border-white/20 bg-white/5 p-6 no-underline hover:border-[#febd17]/50">
        ...
        <Link to="/chantiers" className="block rounded-xl border border-white/20 bg-white/5 p-6 no-underline hover:border-[#febd17]/50">
