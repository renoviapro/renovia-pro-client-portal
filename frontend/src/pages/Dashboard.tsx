  ...
  return (
    <div className="space-y-8 fade-in">
      ...
      <a
        ...
        className="card flex items-center gap-5 p-6 no-underline hover:border-amber-300 group transition-all bg-gradient-to-r from-amber-50 to-transparent border-amber-200"
      >
        <div className="w-14 h-14 rounded-2xl bg-[#FEBD17] flex items-center justify-center shrink-0 shadow-lg shadow-amber-500/20 group-hover:scale-105 transition-transform">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-gray-900 font-semibold text-base">Nouveau projet ?</p>
          <p className="text-gray-500 text-sm mt-1">Demandez un devis gratuit en quelques clics</p>
        </div>
        <div className="hidden sm:flex items-center gap-2 text-[#FEBD17] font-semibold text-sm shrink-0">
          <span>devis.renoviapro.fr</span>
